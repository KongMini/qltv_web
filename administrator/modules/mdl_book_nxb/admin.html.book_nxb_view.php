		...
		<div class="col-xs-12">
			<div class="box">
				<div class="box-header">
					<h4 class="box-title">Danh sách NXB</h4>
					<a href="index.php?module=<?php echo $_REQUEST['module'] ?>&task=book_nxb_add"><button class="btn btn-warning pull-right">Thêm mới <i class="fa fa-plus"></i></button></a>
				</div><!-- /.box-header -->
						...
						<tbody>
							...
							?>
								<tr class="<?php echo ($i % 2 == 1) ? 'bg-gray-light' : ''; ?> valign-middle">
									...
									<td><?= Model::book_nxb_view_link($value) ?></td>
								</tr>
							<?php
							}
							?>
