					...
					<div class="box-body ">
						<div class="nav-tabs-custom">
							<ul class="nav nav-tabs">
								...
								<li class="pull-right"><button type="submit" class="btn btn-primary" name="submit" value="web_home_add">Cập nhật</button></li>
							</ul>
										...
										<div class="col-md-3">
											...
											<div class="form-group">
												<div class="col-md-12">
													...
													<input class="form-control" name="icon" id="icon" type="text" value="" placeholder="Id liên kết với menu..." />
												</div>
											</div>
											...
											<div class="form-group">
												<div class="col-md-12">
													...
													<select id="status" name="status" class="form-control">
														...
														<option selected value="active">Đã xuất bản</option>
					...
					<div class="box-footer">
						<div class="form-group">
							<div class="col-md-12 text-center">
								<button type="submit" class="btn btn-primary" name="submit" value="web_home_add">Cập nhật</button>
							</div>
						</div>
					</div>
				</div><!-- /.box -->
