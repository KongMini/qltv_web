          ...
          <div class="tab-pane active" id="general">
            <form class="form-horizontal" action="index.php?module=<?=$_REQUEST["module"] ?>&task=web_information_edit" id="frm_web_information_edit" method="POST" name="frm_profile_edit" enctype="multipart/form-data">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-4 col-md-4 col-lg-4">
                  <textarea class="form-control" rows="10" name="brief_vi" id="brief_vi" placeholder="Tóm tắt giới thiệu về công ty Tiếng Việt"><?=$ariacms->web_information->brief_vi ?></textarea>
                </div>
                <label for="brief_en" class="col-sm-2 col-md-2 col-lg-2 control-label">Giới thiệu Tiếng Anh :</label>
                <div class="col-sm-4 col-md-4 col-lg-4">
                  <textarea class="form-control" rows="10" name="brief_en" id="brief_en" placeholder="Tóm tắt giới thiệu về công ty Tiếng Anh"><?=$ariacms->web_information->brief_en ?></textarea>
                </div>
              </div>
              <div class="form-group">
                <label for="admin_email" class="col-sm-2 col-md-2 col-lg-2 control-label">Email :</label>
                <div class="col-sm-4 col-md-4 col-lg-4">
                  <input type="text" class="form-control" name="admin_email" id="admin_email" value="<?=$ariacms->web_information->admin_email ?>" />
                </div>
                <label for="fax" class="col-sm-2 col-md-2 col-lg-2 control-label">Fax :</label>
                <div class="col-sm-4 col-md-4 col-lg-4">
                  <input type="text" class="form-control" name="fax" id="fax" value="<?=$ariacms->web_information->fax ?>" />
                </div>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-4 col-md-4 col-lg-4">
                  <input type="text" class="form-control" name="facebook" id="facebook" value="<?=$ariacms->web_information->facebook ?>" />
                </div>
                <label for="twitter" class="col-sm-2 col-md-2 col-lg-2 control-label">Twitter :</label>
                <div class="col-sm-4 col-md-4 col-lg-4">
                  <input type="text" class="form-control" name="twitter" id="twitter" value="<?=$ariacms->web_information->twitter ?>" />
                </div>
              </div>
              <div class="form-group">
                <label for="facebook_count" class="col-sm-2 col-md-2 col-lg-2 control-label">Facebook Count Default:</label>
                <div class="col-sm-4 col-md-4 col-lg-4">
                  <input type="text" class="form-control" name="facebook_count" id="facebook_count" value="<?=$ariacms->web_information->facebook_count ?>" />
                </div>
                <label for="twitter_count" class="col-sm-2 col-md-2 col-lg-2 control-label">Twitter Count Default:</label>
                <div class="col-sm-4 col-md-4 col-lg-4">
                  <input type="text" class="form-control" name="twitter_count" id="twitter_count" value="<?=$ariacms->web_information->twitter_count ?>" />
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-4 col-md-4 col-lg-4">
                  <input type="text" class="form-control" name="youtube" id="youtube" value="<?=$ariacms->web_information->youtube ?>" />
                </div>
                <label for="instagram" class="col-sm-2 col-md-2 col-lg-2 control-label">Instagram :</label>
                <div class="col-sm-4 col-md-4 col-lg-4">
                  <input type="text" class="form-control" name="instagram" id="instagram" value="<?=$ariacms->web_information->instagram ?>" />
                </div>
              </div>
              <div class="form-group">
                <label for="youtube_count" class="col-sm-2 col-md-2 col-lg-2 control-label">Youtube Count Default:</label>
                <div class="col-sm-4 col-md-4 col-lg-4">
                  <input type="text" class="form-control" name="youtube_count" id="youtube_count" value="<?=$ariacms->web_information->youtube_count ?>" />
                </div>
                <label for="instagram_count" class="col-sm-2 col-md-2 col-lg-2 control-label">Instagram Count Default:</label>
                <div class="col-sm-4 col-md-4 col-lg-4">
                  <input type="text" class="form-control" name="instagram_count" id="instagram_count" value="<?=$ariacms->web_information->instagram_count ?>" />
                </div>
              </div>
