...
<section class="content">
	<div class="row">
		<div class="col-xs-12">
			<form method="POST" action="?module=albums&task=news_edit&id=<?= $news_detail['id'] ?>" name="news_edit" id="news_edit" class="form-horizontal">
				<div class="box">
                                            ...
                                            foreach ($images as $key => $image) {
                                                ...
                                                <div class="form-group" id ="<?= $key?>">
                                                    ...
                                                    <div class="col-md-6" style="padding-left:0px;">
                                                        <input class="form-control" type="text" name="imagelist[<?= $key?>]" id="imagelist_<?= $key?>" txthide="imagelist_<?= $key?>" onclick="openPopupImg2(<?= $key?>)" placeholder="Đường dẫn ảnh <?= $key?> cho sản phẩm" value="<?= $image->image_link ?>" />
                                                    </div>
                                                    <div class="col-md-2" style="padding-left:0px;">
                                            ...
                                            onInit: function( finder ) {
                                                finder.on( 'files:choose', function( evt ) {
                                                    ...
                                                    files.forEach( function( file, i ) {
                                                        ...
                                                        $("#frames")
                                                            .append('<div class="form-group" id ="<?= $key?>">' +
                                                                '<div class="col-md-2" style="padding-left:0px;">' +
