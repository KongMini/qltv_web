...
?>
				<tr class="<?php echo ($parent_id == 0) ? 'bg-gray-light' : ''; ?> valign-middle">
					<td><a href="index.php?module=news&post_tags=<?= $news_tags->id ?>&input_submit_search=Tìm+kiếm" target="_blank"><?php echo $str . $news_tags->title_vi ?></a></td>
					<td><a href="index.php?module=news&post_tags=<?= $news_tags->id ?>&input_submit_search=Tìm+kiếm" target="_blank"><?php echo $news_tags->url_part ?></a></td>
					<td><a href="index.php?module=news&post_tags=<?= $news_tags->id ?>&input_submit_search=Tìm+kiếm" target="_blank"><?php echo $news_tags->count ?></a></td>
					<td>
