		...
		<div class="col-xs-12">
			<div class="box">
				<div class="box-header">
					<h4 class="box-title">Danh sách tác giả</h4>
					<a href="index.php?module=<?php echo $_REQUEST['module'] ?>&task=book_author_add"><button class="btn btn-warning pull-right">Thêm mới <i class="fa fa-plus"></i></button></a>
				</div><!-- /.box-header -->
					...
					<table class="table table-bordered table-hover">
						<thead>
							<tr>
								...
								<th>STT</th>
								<th class="col-md-9">Tên tác giả</th>
						...
						<tbody>
							...
							?>
								<tr class="<?php echo ($i % 2 == 1) ? 'bg-gray-light' : ''; ?> valign-middle">
									...
									<td><?= Model::book_author_view_link($value) ?></td>
								</tr>
							<?php
							}
							?>
