					...
					<div class="tab-content">
						<div class="active tab-pane" id="info_general">
							...
							<div class="form-group">
								...
								<div class="col-sm-10 col-md-10 col-lg-10">
									<?php if ($news_group_detail['image'] != '') { ?>
										<img style="height:75px;" id="newimage" txthide="image" class="choiceImg cursor margin" src="<?php echo $news_group_detail['image'] ?>"  onclick="openPopupImg('image')" data-toggle="tooltip" title="Nhấn để đổi ảnh đại diện" />
									<?php } else { ?>
									...
									<input class="form-control " id="image" name="image" type="text" placeholder="Đường dẫn ảnh..." value="<?= $news_group_detail['image'] ?>" />
								</div>
							</div>
							<div class="form-group">
