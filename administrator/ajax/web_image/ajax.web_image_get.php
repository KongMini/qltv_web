		...
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<div class="form-group">
					...
					<div class="col-sm-4 col-md-4 col-lg-4">
						<?php if ($web_image_detail['image'] != '') { ?>
							<img style="height:75px;" id="newimage" txthide="image" class="choiceImg cursor " src="<?php echo $web_image_detail['image'] ?>"  onclick="openPopupImg('image')" data-toggle="tooltip" title="Nhấn để chọn ảnh đại diện trên hệ thống" />
						<?php } else { ?>
							<img style="height:75px;" id="newimage" txthide="image" class="choiceImg cursor " src="templates/aptcms/dist/img/noimage.png"  onclick="openPopupImg('image')" data-toggle="tooltip" title="Nhấn để chọn ảnh đại diện trên hệ thống" />
						<?php } ?>
					</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-4 col-md-4 col-lg-4">
						<input class="form-control " id="image"  onclick="openPopupImg('image')" name="image" type="text" placeholder="Dán đường dẫn ảnh..." value="<?php echo $web_image_detail['image'] ?>" required />
					</div>
