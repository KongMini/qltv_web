		...
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<div class="form-group">
					...
					<div class="col-sm-4 col-md-4 col-lg-4">
						<img style="height:75px;" id="newimage" txthide="image" class="choiceImg cursor " src="templates/aptcms/dist/img/noimage.png" onclick="openPopupImg('image')" data-toggle="tooltip" title="Nhấn để chọn ảnh trên hệ thống" />
					</div>
					<label for="position" class="col-sm-2 col-md-2 col-lg-2 control-label">Vị trí :</label>
					<div class="col-sm-4 col-md-4 col-lg-4">
						<input class="form-control " id="position" name="position" type="text" placeholder="Vị trí hiển thị" />
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-4 col-md-4 col-lg-4">
						<input  onclick="openPopupImg('image')" class="form-control " id="image" name="image" type="text" placeholder="Dán đường dẫn ảnh..." value="" required />
					</div>
