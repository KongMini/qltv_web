...
$query = "SELECT a.id, a.fullname, a.status_public 
	FROM e4_users a 
	WHERE a.status_public != 'danhnhan' AND a.publish = 1 
				...
				<div class="nav-tabs-custom">
					...
					<div class="tab-content">
						...
						<div class=" tab-pane" id="info_document">
							<div class="form-group">
								<div class="col-sm-6 col-md-6 col-lg-6">
									...
									<?php if ($news_detail['image'] != '') { ?>
										<img style="height:75px;" id="newImg" txthide="image" class="choiceImg cursor margin" src="<?php echo $news_detail['image'] ?>" onclick="fcall.fcChoiceImg(this);" data-toggle="tooltip" title="Nhấn để đổi ảnh đại diện" />
									<?php } else { ?>
								...
								<div class="col-sm-6 col-md-6 col-lg-6">
									...
									<?php if ($news_detail['image_thumb'] != '') { ?>
										<img style="height:75px;" id="newImgThumb" txthide="image_thumb" class="choiceImg cursor margin" src="<?php echo $news_detail['image_thumb'] ?>" onclick="fcall.fcChoiceImg(this);" data-toggle="tooltip" title="Nhấn để đổi ảnh đại diện" />
									<?php } else { ?>
							...
							<div class="form-group">
								<div class="col-sm-6 col-md-6 col-lg-6">
									<label>Chọn tác giả cho bài viết</label>
									<select class="form-control select2" id="type" name="user_created" style="width: 100%;">
										...
										foreach ($users as $user) {
											...
											} else if ($user->id == $news_detail['user_created']) {
