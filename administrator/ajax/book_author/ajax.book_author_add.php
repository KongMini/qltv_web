							...
							<!-- <div class="form-group">
								...
								<div class="col-sm-4 col-md-4 col-lg-4">
									<select name="parent" id="parent" class="form-control">
										...
										<?= $ariacms->printMenuOption('e4_term_taxonomy', 'id', 'title_vi', '', '', '', 'book_author'); ?>
									</select>
								</div>
			...
			<div class="modal-footer">
				<div class="form-group">
					<div class="col-md-12 text-center">
						<button type="submit" class="btn btn-primary" name="submit" value="book_author_add">Cập nhật</button>
