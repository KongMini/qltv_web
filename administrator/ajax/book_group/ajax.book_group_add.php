...
<div class="modal-dialog modal-wide">
	<form method="POST" action="?module=book_group&task=book_group_add" name="book_group_add" id="book_group_add" class="form-horizontal">
			...
			<div class="modal-footer">
				<div class="form-group">
					<div class="col-md-12 text-center">
						<button type="submit" class="btn btn-primary" name="submit" value="book_group_add">Cập nhật</button>
