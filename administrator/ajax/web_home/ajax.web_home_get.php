							...
							<div class="form-group">
								...
								<div class="col-sm-4 col-md-4 col-lg-4">
									<select name="parent" id="parent" class="form-control">
										...
										<?php echo  $ariacms->printMenuOption('e4_web_home', 'id', 'title_vi', '', '', $web_home_detail['parent'], ''); ?>
									</select>
								</div>
								<label for="icon" class="col-sm-2 col-md-2 col-lg-2 control-label">Id (Liên kết với menu) :</label>
								<div class="col-sm-4 col-md-4 col-lg-4">
									<input class="form-control" name="icon" id="icon" type="text" placeholder="Chứa class font ví dụ: fa fa-eye, fa fa-laptop,..." value="<?php echo $web_home_detail['icon'] ?>" />
								</div>
							</div>
							<div class="form-group">
						...
						<div class="tab-pane" id="info_description">
							...
							<div class="form-group">
								...
								<div class="col-sm-10 col-md-10 col-lg-10">
									<textarea class="form-control" rows="5" name="content_vi" id="content_vi"><?php echo $web_home_detail['content_vi'] ?></textarea>
							...
							<div class="form-group">
								...
								<div class="col-sm-10 col-md-10 col-lg-10">
									<textarea class="form-control" rows="5" name="content_en" id="content_en"><?php echo $web_home_detail['content_en'] ?></textarea>
									<script type="text/javascript">
