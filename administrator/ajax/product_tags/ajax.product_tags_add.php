...
<div class="modal-dialog modal-wide">
	<form method="POST" action="?module=product_tags&task=product_tags_add" name="product_tags_add" id="product_tags_add" class="form-horizontal">
							...
							<!-- <div class="form-group">
								...
								<div class="col-sm-4 col-md-4 col-lg-4">
									<select name="parent" id="parent" class="form-control">
										...
										<?= $ariacms->printMenuOption('e4_term_taxonomy', 'id', 'title_vi', '', '', '', 'product_tags'); ?>
									</select>
								</div>
			...
			<div class="modal-footer">
				<div class="form-group">
					<div class="col-md-12 text-center">
						<button type="submit" class="btn btn-primary" name="submit" value="product_tags_add">Cập nhật</button>
