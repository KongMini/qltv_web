					...
					<div class="tab-content">
						<div class="active tab-pane" id="info_general">
							...
							<div class="form-group">
								...
								<div class="col-sm-6 col-md-6 col-lg-6">
									<textarea class="form-control" rows="3" name="brief_vi" id="brief_vi" placeholder="Tóm tắt giới thiệu bản tin..."><?= $book_detail['brief_vi'] ?></textarea>
								</div>
								<div class="col-sm-6 col-md-6 col-lg-6">
									<textarea class="form-control" rows="3" name="brief_en" id="brief_en" placeholder="Tóm tắt giới thiệu bản tin..."><?= $book_detail['brief_en'] ?></textarea>
								</div>
							</div>
							<div class="form-group">
						...
						<div class=" tab-pane" id="info_document">
							<div class="form-group">
								<div class="col-sm-6 col-md-6 col-lg-6">
									...
									<?php if ($book_detail['image'] != '') { ?>
										<img style="height:75px;" id="newImg" txthide="image" class="choiceImg cursor margin" src="<?php echo $book_detail['image'] ?>" onclick="fcall.fcChoiceImg(this);" data-toggle="tooltip" title="Nhấn để đổi ảnh đại diện" />
									<?php } else { ?>
									...
									<input class="form-control " id="image" name="image" type="text" placeholder="Đường dẫn ảnh..." value="<?= $book_detail['image'] ?>" />
								</div>
								<div class="col-sm-6 col-md-6 col-lg-6">
									<label for="image_thumb">Ảnh thumb thu nhỏ:</label>
									<?php if ($book_detail['image_thumb'] != '') { ?>
										<img style="height:75px;" id="newImgThumb" txthide="image_thumb" class="choiceImg cursor margin" src="<?php echo $book_detail['image_thumb'] ?>" onclick="fcall.fcChoiceImg(this);" data-toggle="tooltip" title="Nhấn để đổi ảnh đại diện" />
									<?php } else { ?>
									...
									<?php } ?>
									<input class="form-control " id="image_thumb" name="image_thumb" type="text" placeholder="Đường dẫn ảnh..." value="<?= $book_detail['image_thumb'] ?>" />
								</div>
							</div>
							...
							<div class="form-group">
								<div class="col-sm-6 col-md-6 col-lg-6">
									...
									<input class="form-control " id="meta_file_audio" name="meta_file_audio" type="text" placeholder="Đường dẫn file..." value="<?= $book_detail['meta']->meta_file_audio ?>" />
								</div>
								<div class="col-sm-6 col-md-6 col-lg-6">
									...
									<input class="form-control " id="meta_file_pdf" name="meta_file_pdf" type="text" placeholder="Đường dẫn file..." value="<?= $book_detail['meta']->meta_file_pdf ?>" />
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-6 col-md-6 col-lg-6">
									...
									<select id="post_status" name="post_status" class="form-control">
										...
										<option <?= ($book_detail['post_status'] == 'active') ? 'selected' : ''; ?> value="active">Đã xuất bản</option>
										<option <?= ($book_detail['post_status'] == 'waiting') ? 'selected' : ''; ?> value="waiting">Chờ duyệt</option>
										<option <?= ($book_detail['post_status'] == 'deactive') ? 'selected' : ''; ?> value="deactive">Không được duyệt</option>
									</select>
								</div>
								<div class="col-sm-6 col-md-6 col-lg-6">
						...
						<div class="tab-pane" id="info_other">
							...
							<div class="form-group">
								...
								<div class="col-sm-9 col-md-9 col-lg-9">
									<input class="form-control" name="url_part" id="url_part" type="text" onblur="check_value_exist('<?= $book_detail['url_part'] ?>', '#url_part', 'e4_posts', 'url_part', '#error_url_part', 'Đường dẫn URL');" value="<?= $book_detail['url_part'] ?>" />
								</div>
