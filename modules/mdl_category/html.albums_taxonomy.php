                        ...
                        <ul class="menu-cate-artical w-100 float-left" id="">
                            ...
                            foreach ($taxonomies as $taxonomy) {
                                if ($taxonomy->taxonomy == 'category' && $taxonomy->parent == 0) {
                                    ?>
                                    <li class="">
                                        <a href="<?= $ariacms->actual_link . 'tin-tuc/' . $taxonomy->url_part . '.html'; ?>" class="w-100 float-left mb-3 pt-1 <?php if($taxonomy->url_part ==  $task) echo "active"?>" data-slug=""><?= $taxonomy->{$params->title}?></a>
                                    </li>
                        ...
                        <div class="">
                                    ...
                                    while ($curRow < count($news) && ($curRow < $curPg * $maxRows)) {
                                        ...
                                        <div data-id="1151" class="col-lg-6 col-md-6 col-xs-12 col-sm-12 article-item float-left mb-4" style="margin-top: 20px; height: 591.071px; opacity: 1;">
                                            <div class="featured-image w-100 float-left mb-lg-2 mb-md-2 mb-2">
                                                <a href="<?= $ariacms->actual_link . 'tin-tuc/' . $new->ca_url_part . '.html'; ?>" class="centered w-100 float-left">
                                            ...
                                            <div class="detail w-100 float-left">
                                                ...
                                                <a href="<?= $ariacms->actual_link . 'tin-tuc/' . $new->ca_url_part . '.html'; ?>" class="more-content float-left mt-3">
                            ...
                            <div class="col-12 mt-2 floa">
                                <div class="holder w-100 float-left mb-5 ">
                                    ...
                                    <!--                                        <a href="#" class="">2</a><a href="#" class="jp-hidden">3</a><a href="#" class="jp-hidden">4</a><a href="#" class="jp-hidden">5</a><a href="#" class="jp-hidden">6</a><a href="#" class="jp-hidden">7</a><a href="#" class="jp-hidden">8</a><a href="#" class="jp-hidden">9</a><span>...</span><a>10</a>-->
                                    <!--                                        <a class="jp-next">Next</a><a class="jp-last">Last</a></div>-->
                                </div>
