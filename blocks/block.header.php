...
<div id="top-menu" class="row">
                ...
                foreach ($web_menus as $key1 => $web_menu_1) {
                    ...
                    if ($web_menu_1->parent == $type_menus->main->id) {
                        ...
                        if ($web_menu_1->submenu > 0) {
                            ...
                            unset($web_menus[$key1]);
                            echo ' <li><a class="" href="' . $url_link . '" >' . $web_menu_1->{$params->title} . '</a></li>';
                        }
                    }
                }
            }
    ...
    <div id="top-menu-center" class="col-2">
        <a href="/"><img id="desktop-header-logo" alt="logo-home" data-logo-white="/upload/logo/logo_home.png" data-logo-black="<?= $ariacms->web_information->{'image-logo'}?>" src="/upload/logo/logo_home.png" /></a>
    </div>
